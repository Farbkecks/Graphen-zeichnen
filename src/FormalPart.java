...
public class FormalPart {
    ...
    public double calculateVersionOne(){
        switch(this.sign){
            case add: return this.firstNummber;
            case subtract: return this.firstNummber * -1;
            default: {
    ...
    public double calculateVersionThree(double ValueOfX){
        ...
        switch(this.firstOperation){
            case power: resault = Math.pow(firstNumLocal, secNumLocal); break;
            case times: resault = firstNumLocal * secNumLocal; break;
            case divided: resault = firstNumLocal / secNumLocal; break;
            default: {
        ...
        switch(this.sign){
            case add: return resault;
            case subtract: return resault * -1;
            default: {
        ...
        switch(indexPower()){
            case 0:{
               switch(this.firstOperation){
                ...
                case times: resault = resault * thirtNumLocal; break;
                case divided: resault = resault / thirtNumLocal; break;
                default: {
            ...
            case 2:{
                ...
                switch(this.firstOperation){
                    case times: resault = resault * firstNumLocal; break;
                    case divided: resault = resault / firstNumLocal; break;
                    default: {
    ...
    public double calculatePart(double ValueOfX){
        switch(partVersion){
            case one: return calculateVersionOne();
            case three: return calculateVersionThree(ValueOfX);
            case five: return calculateVersionFive(ValueOfX);
            default: {
